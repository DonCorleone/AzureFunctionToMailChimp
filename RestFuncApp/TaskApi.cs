...
namespace RestFuncApp
{
    public static class TaskApi
    {
        ...
        public static IActionResult GetTaskById([HttpTrigger(AuthorizationLevel.Anonymous,"get", Route = "task/{id}")] HttpRequest req,
        ...
        public static async Task<IActionResult> UpdateTask([HttpTrigger(AuthorizationLevel.Anonymous,"put", Route = "task/{id}")] HttpRequest req,
            ILogger log, string id)
        {
            var task = Items.FirstOrDefault(t => t.Id == id);
            if (task == null)
        ...
        public static IActionResult DeleteTask([HttpTrigger(AuthorizationLevel.Anonymous, "delete", Route = "task/{id}")] HttpRequest req,
            ILogger log, string id)
        {
            var task = Items.FirstOrDefault(t => t.Id == id);
            if (task == null)
